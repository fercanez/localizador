<div class="map-sideElement" id="capas">
  <div class="test-container">
    <div class="listado-capas">
      <div class="map-sidePanel-header">
        <h3>Capas</h3>
        <div class="settings-link-container">
          <a href="#" class="" onclick="openActiveLayers()" >
            <p>Ajustes</p>
          </a>
          <a href="#" class="settings-gear-link" onclick="openActiveLayers()" >
      ...
      <div class="sidePanel-content" data-side="left">

      <?php include "includes/sidePanels/listadoCapas.php" ?>

          <!-- <?php include "includes/sidePanels/simbologia.php" ?> -->
      </div>
    </div>
    <?php include "simbologia.php" ?>
  </div>
...
<script>
  // Simbología: ver js/simbologiaPanel.js
    ...
    if (accordionsMenu.length > 0 && window.requestAnimationFrame) {
      ...
      function animateAccordion(input) {
        if (
          !input ||
          !input.classList ||
          !input.classList.contains("cd-accordion__input")
        ) {
          return;
        }
